...
<div className="navbar__first-serch">
    <input type="text" className="navbar__first-serchbar" placeholder="facebook-serch" />
    <FaSistrix className="navbar__searchIcon"/>
        ...
        <div className="navbar__middle">
            ...
            </span> <span className="middleIcon">
